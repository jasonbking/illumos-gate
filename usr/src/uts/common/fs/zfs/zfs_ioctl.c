...
zfs_ioctl_init(void)
{
	...
	zfs_ioctl_register("destroy_bookmarks", ZFS_IOC_DESTROY_BOOKMARKS,
	    ...
	    POOL_CHECK_SUSPENDED | POOL_CHECK_READONLY, B_TRUE, B_TRUE,
	    zfs_keys_destroy_bookmarks, ARRAY_SIZE(zfs_keys_destroy_bookmarks));

	zfs_ioctl_register("load-key", ZFS_IOC_LOAD_KEY,
	    zfs_ioc_load_key, zfs_secpolicy_load_key, DATASET_NAME,
	    zfs_unalias_dsname, zfs_alias_dsname,
	...
	zfs_ioctl_register("unload-key", ZFS_IOC_UNLOAD_KEY,
	    zfs_ioc_unload_key, zfs_secpolicy_load_key, DATASET_NAME,
	    zfs_unalias_dsname, zfs_alias_dsname,
	    POOL_CHECK_SUSPENDED, B_TRUE, B_TRUE,
	...
	zfs_ioctl_register("change-key", ZFS_IOC_CHANGE_KEY,
	    ...
	    DATASET_NAME, zfs_unalias_dsname, zfs_alias_dsname,
	    POOL_CHECK_SUSPENDED | POOL_CHECK_READONLY, B_TRUE, B_TRUE,
	    zfs_keys_change_key, ARRAY_SIZE(zfs_keys_change_key));
	...
	zfs_ioctl_register("channel_program", ZFS_IOC_CHANNEL_PROGRAM,
	    ...
	    POOL_NAME, zfs_unalias_poolname, zfs_alias_poolname,
	    POOL_CHECK_SUSPENDED | POOL_CHECK_READONLY, B_TRUE, B_TRUE,
	    zfs_keys_channel_program, ARRAY_SIZE(zfs_keys_channel_program));
