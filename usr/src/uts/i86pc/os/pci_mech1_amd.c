...
uint8_t
pci_mech1_amd_getb(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint8_t val;
...
uint16_t
pci_mech1_amd_getw(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint16_t val;
...
uint32_t
pci_mech1_amd_getl(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint32_t val;
...
void
pci_mech1_amd_putb(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint8_t val)
{
	if (device == PCI_MECH1_SPEC_CYCLE_DEV &&
	    function == PCI_MECH1_SPEC_CYCLE_FUNC) {
...
void
pci_mech1_amd_putw(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint16_t val)
{
	if (device == PCI_MECH1_SPEC_CYCLE_DEV &&
	    function == PCI_MECH1_SPEC_CYCLE_FUNC) {
...
void
pci_mech1_amd_putl(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint32_t val)
{
	if (device == PCI_MECH1_SPEC_CYCLE_DEV &&
	    function == PCI_MECH1_SPEC_CYCLE_FUNC) {
