...
uint8_t
pci_neptune_getb(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint8_t	val;
...
uint16_t
pci_neptune_getw(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint16_t val;
...
uint32_t
pci_neptune_getl(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint32_t val;
...
void
pci_neptune_putb(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint8_t val)
{
	pci_neptune_enable();
...
void
pci_neptune_putw(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint16_t val)
{
	pci_neptune_enable();
...
void
pci_neptune_putl(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint32_t val)
{
	pci_neptune_enable();
