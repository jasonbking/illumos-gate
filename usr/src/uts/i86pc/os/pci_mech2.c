...
uint8_t
pci_mech2_getb(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint8_t tmp;
	uint8_t val;
...
uint16_t
pci_mech2_getw(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint8_t	tmp;
	uint16_t val;
...
uint32_t
pci_mech2_getl(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg)
{
	uint8_t		tmp;
	uint32_t	val;
...
void
pci_mech2_putb(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint8_t val)
{
	uint8_t	tmp;
...
void
pci_mech2_putw(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint16_t val)
{
	uint8_t	tmp;
...
void
pci_mech2_putl(uint8_t bus, uint8_t device, uint8_t function, uint8_t reg,
    uint32_t val)
{
	uint8_t	tmp;
