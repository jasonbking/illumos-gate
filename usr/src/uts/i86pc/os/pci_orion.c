...
uint8_t
pci_orion_getb(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint8_t	val;
...
uint16_t
pci_orion_getw(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint16_t val;
...
uint32_t
pci_orion_getl(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg)
{
	uint32_t	val;
...
void
pci_orion_putb(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint8_t val)
{
	FuncDisableInboundPostingnc82454();
...
void
pci_orion_putw(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint16_t val)
{
	FuncDisableInboundPostingnc82454();
...
void
pci_orion_putl(uint8_t bus, uint8_t device, uint8_t function, uint16_t reg,
    uint32_t val)
{
	FuncDisableInboundPostingnc82454();
