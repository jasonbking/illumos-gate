...
extern uint32_t pci_mech1_getl(uint8_t bus, uint8_t dev, uint8_t func,
    uint16_t reg);
extern void pci_mech1_putb(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint8_t val);
extern void pci_mech1_putw(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint16_t val);
extern void pci_mech1_putl(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint32_t val);
...
extern uint32_t pci_mech2_getl(uint8_t bus, uint8_t dev, uint8_t func,
    uint16_t reg);
extern void pci_mech2_putb(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint8_t val);
extern void pci_mech2_putw(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint16_t val);
extern void pci_mech2_putl(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint32_t val);
...
extern uint32_t pci_orion_getl(uint8_t bus, uint8_t dev, uint8_t func,
    uint16_t reg);
extern void pci_orion_putb(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint8_t val);
extern void pci_orion_putw(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint16_t val);
extern void pci_orion_putl(uint8_t bus, uint8_t dev, uint8_t func, uint16_t reg,
    uint32_t val);
